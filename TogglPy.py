...
class Toggl():
    ...
    def createTimeEntry(self, hourduration, projectid=None, projectname=None,\
                        clientname=None, year=None, description=None,\
        ...
        :param description: Can speed up project query process
        ne, day=None, hour=None, minute=None):
